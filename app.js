...
// Adding validation for food email
expressValidator.validator.extend('isFoodMail', function (str) {
    if (str.indexOf("@thefood.com") > -1){
      return true;
    } 
    return false;
});
...
app.get('/keys/remove/:keyId', homeController.getRemoveKey);
