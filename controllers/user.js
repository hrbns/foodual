...
exports.postSignup = function(req, res, next) {
  req.assert('email', 'Email is not valid').isEmail();
  req.assert('email', 'Email must be on thefood.com domain').isFoodMail();
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'foodual@thefood.com',
        subject: 'Activate your account on Foodual',
...
exports.getActivate = function(req, res, next) {
  ...
  req.flash('success', { msg: 'Activation successful!'});
  res.redirect('/');
};
